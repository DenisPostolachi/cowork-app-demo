...
function SetScaleModal() {
  ...
  return (
    <>
      <Tooltip
        title={<span className={classes.toolTip}>Change Scale</span>}
        placement="top"
        arrow
      >
        <Fab
      ...
      >
        <Paper className={classes.paper}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Typography variant="h6">Grid Scale</Typography>
            </Grid>
                  ...
                  <Grid container className={classes.inputContainer}>
                    <Grid item>
                      <NumericInput
                        ...
                        size={3}
                        value={inchesInput}
                        onChange={(e) => handleInchesInput(e)}
                      />
                    </Grid>
                    <Grid item xs>
